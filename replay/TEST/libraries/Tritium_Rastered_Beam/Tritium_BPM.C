...
ClassImp(Tritium_BPM)

//_____________________________________________________________________________
Tritium_BPM::Tritium_BPM( const char* name, const char* description,
...
//                         inconsistent data
//
Int_t Tritium_BPM::ReadDatabase( const TDatime& date )
{
...
//_____________________________________________________________________________
Int_t Tritium_BPM::DefineVariables( EMode mode )
{
...
//_____________________________________________________________________________
Int_t Tritium_BPM::Decode( const THaEvData& evdata )
{
