...
Tritium_Raster::Tritium_Raster( const char* name, const char* description,
...
//                         inconsistent data
//
Int_t Tritium_Raster::ReadDatabase( const TDatime& date )
{
...
//_____________________________________________________________________________
Int_t Tritium_Raster::DefineVariables( EMode mode )
{
...
//_____________________________________________________________________________
inline 
void Tritium_Raster::ClearEvent()
{
...
//_____________________________________________________________________________
Int_t Tritium_Raster::Decode( const THaEvData& evdata )
{
