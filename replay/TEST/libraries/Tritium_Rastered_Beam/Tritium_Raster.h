#ifndef ROOT_Tritium_Raster
#define ROOT_Tritium_Raster
...
class Tritium_Raster : public THaBeamDet {

public:
  Tritium_Raster( const char* name, const char* description = "",
		   THaApparatus* a = NULL );
  virtual ~Tritium_Raster();
...
protected:
  ...
  //  Tritium_Raster() {}
  //  Tritium_Raster( const Tritium_Raster& ) {}
  Tritium_Raster& operator=( const Tritium_Raster& ) { return *this; }
  ...
  ClassDef(Tritium_Raster,0)   // Generic Raster class
};
