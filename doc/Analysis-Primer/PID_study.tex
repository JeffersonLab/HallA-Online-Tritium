...
\includegraphics[width=3in]{pid1.eps}
\end{minipage}
}
\subfigure[kin15]{
\begin{minipage}[t]{0.4\linewidth}
...
\includegraphics[width=3in]{PIDD1.png}
\end{minipage}
}
\subfigure[non-electron effciency for Cherenkov]{
\begin{minipage}[t]{0.5\linewidth}

\includegraphics[width=3in]{PIDD2.png}
\end{minipage}
}
...
\includegraphics[width=3in]{PIDD3.png}
\end{minipage}
}
\subfigure[electron effciency for calorimeter]{
\begin{minipage}[t]{0.5\linewidth}

\includegraphics[width=3in]{PID4.png}
\end{minipage}
}
